...
-- --------------------------------------------------
-- Date Created: 06/06/2017 17:06:16
-- Generated from EDMX file: E:\EXER ASP.NET\ProjetosAspNet\CadastroMP\Model\CadastroMaquinas.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [CadastroMaquinas];
GO
...
ALTER TABLE [dbo].[Produtos]
ADD CONSTRAINT [FK_MaquinaProdutos]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_MaquinaProdutos'
CREATE INDEX [IX_FK_MaquinaProdutos]
ON [dbo].[Produtos]
    ([MaquinaId]);
GO
